...
(multimodal: tren/bus/vuelo). Para verificación en vivo de Omio también existe
[`tools/`](../tools/README.md) (sesión local vía CDP), útil sobre todo para los 2 vuelos.
...
> (Volterra: rome2rio no da horarios, valor aproximado). 🔎 = confirmar en vivo (vuelos varían
> día a día — verificar en la aerolínea / Omio). Normalizado a MXN (USD≈18).
...
A esto súmale los **transfers de aeropuerto** (abajo, ~$800–1,200 MXN pareja).
...
## Transfers de aeropuerto (aparte de la tabla)

- **París (Beauvais BVA):** si el vuelo de Ryanair llega a Beauvais, está lejos de París →
  shuttle ~1h15, ~€17/persona cada vía. Si consiguen vuelo a Orly/CDG, mejor. 🔎
- **BGY, FCO:** bus/tren al centro, ~€5–15/persona por trayecto.
- Presupuestar ~**€40–60 / pareja (~$800–1,200 MXN)** en transfers de aeropuerto.
...
- **Dos vuelos internos (Bérgamo→París, París→Roma)** son los tramos caros y el factor que
  ...
  comprar** (más barata que en el aeropuerto). Comparar aeropuerto de llegada en París
  (Beauvais vs Orly/CDG) por el costo+tiempo del transfer.
- **Trenes de alta velocidad** (Roma→Florencia): tarifa Economy anticipada es mucho más barata
  que la Base; comprar con tiempo.
- **Verona y Padua = paradas:** comprar dos tramos regionales separados (permite bajar y seguir).
...
- **Volterra → Milán (11 oct):** tramo largo (bus + tren ~5–6h). Salir a medio día, comprar el
  Frecciarossa anticipado y dormir cerca de MXP esa noche para el vuelo de las 06:55 del 12 oct.

## Fuentes

- Skill `busqueda-transporte` → rome2rio + Omio vía FireCrawl (ver `.claude/skills/busqueda-transporte/`).
- Verificación en vivo de Omio: [`tools/`](../tools/README.md) (sesión local vía CDP).
- [seat61 — trenes en Italia 2026](https://www.seat61.com/train-travel-in-italy.htm) · [Frecciarossa](https://www.seat61.com/trains-and-routes/frecciarossa.htm)
- [Rome2Rio](https://www.rome2rio.com/) · [Omio](https://www.omio.com/) · [Ryanair desde Bérgamo](https://www.ryanair.com/)

> Snapshot: 31 may 2026. Ruta v1 (con París). Precios de rome2rio + Omio en MXN; los vuelos (🔎)
> conviene confirmarlos en vivo. Reconfirmar tarifas al acercarse la fecha.
